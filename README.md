...
using the more conservative classification. Diagnostic interval endpoints are
normalized internally, so crossed raw quantiles do not produce negative interval
widths when `sort_quantiles=False`.
